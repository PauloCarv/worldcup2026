...
window.WC = (function () {
  ...
  const groups = {
    ...
    B: { teams: ["CAN", "BIH", "QAT", "SUI"], matches: [
      ...
      ["CAN","QAT",6,0,2,"Jun 18","18:00","Toronto"],
      ["SUI","BIH",4,1,2,"Jun 18","15:00","Vancouver"],
      ["SUI","CAN",null,null,3,"Jun 24","15:00","Vancouver"],
      ["BIH","QAT",null,null,3,"Jun 24","15:00","Seattle"],
    ]},
    ...
    E: { teams: ["GER", "CUW", "CIV", "ECU"], matches: [
      ["GER","CUW",7,1,1,"Jun 14","18:00","Philadelphia"],
    ...
    F: { teams: ["NED", "JPN", "SWE", "TUN"], matches: [
      ...
      ["JPN","SWE",null,null,3,"Jun 25","19:00","Dallas"],
      ["TUN","NED",null,null,3,"Jun 25","19:00","Houston"],
    ]},
    G: { teams: ["BEL", "EGY", "IRN", "NZL"], matches: [
      ["BEL","EGY",3,0,1,"Jun 15","18:00","Boston"],
      ["IRN","NZL",1,0,1,"Jun 15","15:00","Seattle"],
      ["BEL","IRN",2,1,2,"Jun 21","18:00","Boston"],
      ["NZL","EGY",1,2,2,"Jun 21","15:00","Seattle"],
      ["NZL","BEL",null,null,3,"Jun 26","16:00","Boston"],
      ["EGY","IRN",null,null,3,"Jun 26","16:00","Seattle"],
    ]},
    H: { teams: ["ESP", "CPV", "KSA", "URU"], matches: [
      ["ESP","CPV",3,1,1,"Jun 15","21:00","San Francisco"],
      ["KSA","URU",0,1,1,"Jun 15","18:00","Los Angeles"],
      ["ESP","KSA",2,0,2,"Jun 21","21:00","San Francisco"],
      ["URU","CPV",1,1,2,"Jun 21","18:00","Los Angeles"],
      ["URU","ESP",null,null,3,"Jun 26","19:00","San Francisco"],
      ["CPV","KSA",null,null,3,"Jun 26","19:00","Los Angeles"],
    ]},
    I: { teams: ["FRA", "SEN", "IRQ", "NOR"], matches: [
      ["FRA","SEN",2,1,1,"Jun 16","18:00","Atlanta"],
      ["IRQ","NOR",1,3,1,"Jun 16","15:00","Miami"],
      ["FRA","IRQ",3,0,2,"Jun 22","18:00","Atlanta"],
      ["NOR","SEN",2,1,2,"Jun 22","15:00","Miami"],
      ["IRQ","FRA",null,null,3,"Jun 26","16:00","Atlanta"],
      ["SEN","NOR",null,null,3,"Jun 26","16:00","Miami"],
    ]},
    J: { teams: ["ARG", "ALG", "AUT", "JOR"], matches: [
      ["ARG","ALG",3,1,1,"Jun 16","21:00","Kansas City"],
      ["AUT","JOR",2,0,1,"Jun 16","18:00","Houston"],
      ["ARG","AUT",2,0,2,"Jun 22","21:00","Kansas City"],
      ["JOR","ALG",0,1,2,"Jun 22","18:00","Houston"],
    ...
    L: { teams: ["ENG", "CRO", "GHA", "PAN"], matches: [
      ["ENG","CRO",2,0,1,"Jun 17","21:00","Boston"],
      ["GHA","PAN",1,0,1,"Jun 17","18:00","Dallas"],
      ["ENG","GHA",1,1,2,"Jun 23","21:00","Boston"],
      ["PAN","CRO",0,2,2,"Jun 23","18:00","Dallas"],
      ["PAN","ENG",null,null,3,"Jun 27","19:00","Boston"],
      ["CRO","GHA",null,null,3,"Jun 27","19:00","Dallas"],
    ]},
  };
